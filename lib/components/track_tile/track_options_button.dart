    ...
    return showPopover(
      ...
      builder: (context) {
        return SizedBox(
          ...
          // Without this boundary the rows inherit the track row's own
          // hovered/focused states and every entry renders as if the cursor
          // were on it. Same reason `AdaptivePopSheetList` wraps its menu.
