...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get hipotetical_calculation => '*تمّ الحساب بمعدّل دفعة تتراوح بين 0.003–0.005 دولار أمريكي لكل تشغيل على منصات الموسيقى عبر الإنترنت. هذا حساب افتراضي لتوضيح للمستخدم مقدار ما كان سيدفعه للفنانين لو استمع إلى أغنيتهم على منصات مختلفة.';
  ...
  @override
  String get no_default_metadata_provider_selected => 'لم تقُم بتعيين مزود بيانات افتراضي';
  ...
  @override
  String get do_you_want_to_open_the_following_link => 'هل ترغب في فتح الرابط التالي؟';

  @override
  String get unsafe_url_warning => 'قد يكون فتح الروابط من مصادر غير موثوقة غير آمن. تحرّ الحذر!\nيمكنك أيضًا نسخ الرابط إلى الحافظة.';

  @override
  String get copy_link => 'نسخ الرابط';

  @override
  String get building_your_timeline => 'جاري بناء المخطط الزمني استنادًا إلى استماعاتك...';
  ...
  @override
  String get plugin_scrobbling_info => 'تقوم هذه الإضافة بتتبع مقاطعك الموسيقية لإنشاء سجل الاستماع الخاص بك.';

  @override
  String get default_metadata_source => 'مصدر البيانات الوصفية الافتراضي';

  @override
  String get set_default_metadata_source => 'تعيين مصدر البيانات الوصفية الافتراضي';
  ...
  @override
  String get do_you_want_to_install_this_plugin => 'هل ترغب في تثبيت هذه الإضافة؟';

  @override
  String get third_party_plugin_warning => 'هذه الإضافة من مستودع طرف ثالث. تأكد من موثوقية المصدر قبل التثبيت.';
  ...
  @override
  String get synced_lyrics_not_available => 'الكلمات المتزامنة غير متوفرة لهذه الأغنية. يُرجى استخدام';
  ...
  @override
  String get configure_plugins => 'قم بتكوين مزود البيانات الوصفية ومكونات مصدر الصوت الخاصة بك';
  ...
  @override
  String get dab_music_source_description => 'لمحبي الصوتيات. يوفر تدفقات صوتية عالية الجودة/بدون فقدان. مطابقة دقيقة للمسارات بناءً على ISRC.';
}
