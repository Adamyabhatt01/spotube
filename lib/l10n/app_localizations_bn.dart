...
class AppLocalizationsBn extends AppLocalizations {
  ...
  @override
  String get hipotetical_calculation => '*এটি নিরূপণ করা হয়েছে গড় অনলাইন মিউজিক স্ট্রিমিং প্ল্যাটফর্মের প্রতি স্ট্রিম 0.003–0.005 USD পেআউটের ভিত্তিতে। এটি একটি কাল্পনিক হিসাব যা ব্যবহারকারীকে ধারণা দিতে পারে তারা অন্যান্য স্ট্রিমিং প্ল্যাটফর্মে একই গান শোনার জন্য শিল্পীদের কত টাকা দিয়েছেন হোক।';
  ...
  @override
  String get no_default_metadata_provider_selected => 'আপনি কোনো ডিফল্ট মেটাডেটা প্রদানকারী সেট করেননি';
  ...
  @override
  String get do_you_want_to_open_the_following_link => 'নিচের লিংকটি খুলতে চান?';

  @override
  String get unsafe_url_warning => 'অবিশ্বাসযোগ্য উৎস থেকে লিংক খোলা নিরাপদ নাও হতে পারে। সতর্ক থাকুন!\nআপনি এটি ক্লিপবোর্ডে কপি করতে পারেন।';

  @override
  String get copy_link => 'লিংক কপি করুন';

  @override
  String get building_your_timeline => 'আপনার শোনার ধারা অনুযায়ী টাইমলাইন তৈরি করা হচ্ছে...';
  ...
  @override
  String get plugin_scrobbling_info => 'এই প্লাগইনটি আপনার সঙ্গীত স্ক্রোব্বল করে আপনার শোনা ইতিহাস তৈরি করে।';
  ...
  @override
  String get do_you_want_to_install_this_plugin => 'আপনি কি এই প্লাগইন ইনস্টল করতে চান?';

  @override
  String get third_party_plugin_warning => 'এই প্লাগইন একটি তৃতীয় পক্ষের রেপোজিটরির। ইনস্টল করার আগে উৎস বিশ্বস্ত কিনা নিশ্চিত করুন।';
  ...
  @override
  String get install_a_metadata_provider => 'একটি মেটাডেটা প্রদানকারী ইনস্টল করুন';

  @override
  String get no_tracks_playing => 'বর্তমানে কোনো ট্র্যাক শোনা হচ্ছে না';

  @override
  String get synced_lyrics_not_available => 'এই গানের জন্য সিঙ্ক্রোনাইজড লিরিক্স পাওয়া যায় না। অনুগ্রহ করে ব্যবহার করুন';
  ...
  @override
  String get third_party_plugin_dmca_notice => 'Spotube দল কোনো “তৃতীয় পক্ষ” প্লাগইনের জন্য কোনো (আইনগত সহ) দায়িত্ব নেয় না। নিজের বিপদে ব্যবহার করুন। কোনো বাগ/সমস্যা হলে প্লাগইন রেপোজিটরিতে জানাতে অনুরোধ করা হচ্ছে।\n\nযদি কোনো “তৃতীয় পক্ষ” প্লাগইন কোনো পরিষেবা/আইনগত সংস্থার ToS/DMCA ভূঙ্গ করে, অনুগ্রহ করে “তৃতীয় পক্ষ” প্লাগইনের লেখক বা হোস্টিং প্ল্যাটফর্মে (যেমন GitHub/Codeberg) পদক্ষেপ নিতে বলুন। “তৃতীয় পক্ষ” লেবেলযুক্ত যুক্তিগুলি সকলই পাবলিক/কমিউনিটি দ্বারা রক্ষণাবেক্ষণ করা হয়; আমরা সেগুলি কিউরেট করি না, তাই আমরা কোনো পদক্ষেপ নিতে পারি না।\n\n';

  @override
  String get input_does_not_match_format => 'ইনপুট প্রয়োজনীয় ফরম্যাটের সাথে মেলে না';

  @override
  String get plugins => 'প্লাগইন';

  @override
  String get paste_plugin_download_url => 'ডাউনলোড URL বা GitHub/Codeberg রিপো URL বা .smplug ফাইলের সরাসরি লিঙ্ক পেস্ট করুন';

  @override
  String get download_and_install_plugin_from_url => 'URL থেকে প্লাগইন ডাউনলোড এবং ইনস্টল করুন';
  ...
  @override
  String get configure_plugins => 'আপনার নিজের মেটাডেটা প্রদানকারী এবং অডিও উৎস প্লাগইন কনফিগার করুন';
  ...
  @override
  String get dab_music_source_description => 'অডিওফাইলদের জন্য। উচ্চ-মানের/লসলেস অডিও স্ট্রিম প্রদান করে। সঠিক ISRC ভিত্তিক ট্র্যাক ম্যাচিং।';
}
