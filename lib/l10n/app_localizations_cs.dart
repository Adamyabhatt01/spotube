...
class AppLocalizationsCs extends AppLocalizations {
  ...
  @override
  String get hipotetical_calculation => '*Toto je vypočítáno na základě průměrného výplatu za přehrání 0,003–0,005 USD na online hudebních streamovacích platformách. Jedná se o hypotetický výpočet, který má uživateli ukázat, kolik by umělci dostali, pokud by jeho píseň poslouchal na jiné platformě.';
  ...
  @override
  String get no_default_metadata_provider_selected => 'Nemáte nastaven výchozí poskytovatel metadat';
  ...
  @override
  String get do_you_want_to_open_the_following_link => 'Chcete otevřít následující odkaz?';

  @override
  String get unsafe_url_warning => 'Odkazy z nedůvěryhodných zdrojů mohou být nebezpečné. Buďte opatrní!\nOdkaz si také můžete zkopírovat do schránky.';

  @override
  String get copy_link => 'Zkopírovat odkaz';

  @override
  String get building_your_timeline => 'Vytváří se váš časový přehled podle poslechů...';
  ...
  @override
  String get plugin_scrobbling_info => 'Tento plugin scrobbles vaši hudbu pro vytvoření historie poslechů.';
  ...
  @override
  String get do_you_want_to_install_this_plugin => 'Chcete tento plugin nainstalovat?';

  @override
  String get third_party_plugin_warning => 'Tento plugin pochází z repozitáře třetí strany. Ujistěte se, že důvěřujete zdroji, než ho nainstalujete.';

  @override
  String get author => 'Autor';

  @override
  String get this_plugin_can_do_following => 'Tento plugin může provádět následující úkony';

  @override
  String get install => 'Instalovat';

  @override
  String get install_a_metadata_provider => 'Nainstalovat poskytovatele metadat';

  @override
  String get no_tracks_playing => 'Momentálně není přehrávána žádná skladba';

  @override
  String get synced_lyrics_not_available => 'Synchronizované texty nejsou k dispozici k této písni. Prosím použijte';
  ...
  @override
  String get configure_plugins => 'Konfigurujte své vlastní pluginy poskytovatele metadat a zdroje zvuku';
  ...
  @override
  String get dab_music_source_description => 'Pro audiofily. Poskytuje vysoce kvalitní/bezztrátové zvukové toky. Přesná shoda skladeb na základě ISRC.';
}
