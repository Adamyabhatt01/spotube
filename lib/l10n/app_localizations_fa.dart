...
class AppLocalizationsFa extends AppLocalizations {
  ...
  @override
  String get hipotetical_calculation => '*این محاسبه بر اساس میانگین پرداخت به ازای هر پخش (0.003 تا 0.005 دلار) در پلتفرم‌های استریم موزیک آنلاین انجام شده است. این یک محاسبه فرضی است که به کاربر دیدی از مقدار پرداختی به هنرمندان در صورت گوش دادن به آهنگ آن‌ها در پلتفرم‌های مختلف ارائه می‌دهد.';
  ...
  @override
  String get no_default_metadata_provider_selected => 'هیچ ارائه‌دهندهٔ پیش‌فرض متادیتا تعیین نکرده‌اید';
  ...
  @override
  String get do_you_want_to_open_the_following_link => 'آیا می‌خواهید لینک زیر را باز کنید؟';

  @override
  String get unsafe_url_warning => 'باز کردن لینک از منابع نامطمئن می‌تواند ناامن باشد. مراقب باشید!\nهمچنین می‌توانید لینک را در کلیپ‌بورد خود کپی کنید.';

  @override
  String get copy_link => 'کپی لینک';

  @override
  String get building_your_timeline => 'در حال ساخت جدول زمانی بر اساس شنیده‌هایتان…';
  ...
  @override
  String get plugin_scrobbling_info => 'این افزونه موسیقی شما را اسکراب می‌کند تا تاریخچهٔ شنیداری‌تان را تولید کند.';
  ...
  @override
  String get do_you_want_to_install_this_plugin => 'می‌خواهید این افزونه را نصب کنید؟';

  @override
  String get third_party_plugin_warning => 'این افزونه از مخزن شخص ثالث آمده است. لطفاً قبل از نصب از منابع آن مطمئن شوید.';

  @override
  String get author => 'نویسنده';

  @override
  String get this_plugin_can_do_following => 'این افزونه می‌تواند موارد زیر را انجام دهد';
  ...
  @override
  String get synced_lyrics_not_available => 'متن هم‌زمان‌شده برای این آهنگ در دسترس نیست. لطفاً از';
  ...
  @override
  String get third_party_plugin_dmca_notice => 'تیم Spotube هیچ مسئولیتی (حتی قانونی) در قبال افزونه‌های \"شخص ثالث\" ندارد. از آن‌ها به‌خاطر خود استفاده کنید. برای خطاها/مشکلات، لطفاً در مخزن افزونه گزارش دهید.\n\nاگر هر افزونهٔ \"شخص ثالث\" قوانین ToS/DMCA سرویس یا نهاد قانونی را نقض کند، لطفاً از نویسندهٔ افزونه یا پلتفرم میزبانی (مثل GitHub/Codeberg) درخواست اقدام کنید. افزونه‌هایی که با برچسب \"شخص ثالث\" مشخص شده‌اند، عمومی هستند و توسط جامعه نگهداری می‌شوند؛ ما آن‌ها را تغییر یا مدیریت نمی‌کنیم و نمی‌توانیم دخالت کنیم.\n\n';

  @override
  String get input_does_not_match_format => 'ورودی با قالب مورد نیاز تطابق ندارد';

  @override
  String get plugins => 'افزونه‌ها';

  @override
  String get paste_plugin_download_url => 'URL دانلود یا مخزن GitHub/Codeberg یا لینک مستقیم فایل .smplug را الصاق کنید';

  @override
  String get download_and_install_plugin_from_url => 'دانلود و نصب افزونه از طریق لینک';
  ...
  @override
  String get configure_plugins => 'افزونه‌های منبع صوت و ارائه‌دهنده فراداده خود را پیکربندی کنید';
  ...
  @override
  String get dab_music_source_description => 'مخصوص علاقه‌مندان صدا. ارائه‌دهنده استریم‌های باکیفیت/بدون افت. تطبیق دقیق آهنگ بر اساس ISRC.';
}
