...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get connection_request_denied => 'Connexion refusée. L\'utilisateur a refusé l\'accès.';
  ...
  @override
  String get no_default_metadata_provider_selected => 'Vous n\'avez pas de fournisseur de métadonnées par défaut';

  @override
  String get manage_metadata_providers => 'Gérer les fournisseurs de métadonnées';

  @override
  String get open_link_in_browser => 'Ouvrir le lien dans le navigateur ?';

  @override
  String get do_you_want_to_open_the_following_link => 'Voulez-vous ouvrir le lien suivant';

  @override
  String get unsafe_url_warning => 'L\'ouverture de liens provenant de sources non fiables peut être dangereuse. Soyez prudent !\nVous pouvez également copier le lien dans votre presse-papiers.';

  @override
  String get copy_link => 'Copier le lien';

  @override
  String get building_your_timeline => 'Construction de votre chronologie en fonction de vos écoutes...';
  ...
  @override
  String get plugin_requires_authentication => 'Le plugin nécessite une authentification';
  ...
  @override
  String get plugin_scrobbling_info => 'Ce plugin scrobble votre musique pour générer votre historique d\'écoute.';

  @override
  String get default_metadata_source => 'Source de métadonnées par défaut';

  @override
  String get set_default_metadata_source => 'Définir la source de métadonnées par défaut';
  ...
  @override
  String get support_plugin_development => 'Soutenir le développement de plugins';
  ...
  @override
  String get do_you_want_to_install_this_plugin => 'Voulez-vous installer ce plugin ?';

  @override
  String get third_party_plugin_warning => 'Ce plugin provient d\'un dépôt tiers. Assurez-vous de faire confiance à la source avant de l\'installer.';
  ...
  @override
  String get install_a_metadata_provider => 'Installer un fournisseur de métadonnées';

  @override
  String get no_tracks_playing => 'Aucune piste n\'est en cours de lecture actuellement';

  @override
  String get synced_lyrics_not_available => 'Les paroles synchronisées ne sont pas disponibles pour cette chanson. Veuillez utiliser l\'onglet';
  ...
  @override
  String get upload_plugin_from_file => 'Télécharger le plugin à partir d\'un fichier';
  ...
  @override
  String get configure_plugins => 'Configurez vos propres plugins de fournisseur de métadonnées et de source audio';
  ...
  @override
  String get dab_music_source_description => 'Pour les audiophiles. Fournit des flux audio de haute qualité/sans perte. Correspondance précise des pistes basée sur ISRC.';
}
