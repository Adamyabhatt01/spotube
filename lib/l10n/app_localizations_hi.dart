...
class AppLocalizationsHi extends AppLocalizations {
  ...
  @override
  String get no_default_metadata_provider_selected => 'आपने कोई डिफ़ॉल्ट मेटाडेटा प्रदाता सेट नहीं किया है';
  ...
  @override
  String get do_you_want_to_open_the_following_link => 'क्या आप निम्नलिखित लिंक खोलना चाहते हैं';

  @override
  String get unsafe_url_warning => 'अविश्वसनीय स्रोतों से लिंक खोलना असुरक्षित हो सकता है। सावधान रहें!\nआप लिंक को अपने क्लिपबोर्ड पर भी कॉपी कर सकते हैं।';

  @override
  String get copy_link => 'लिंक कॉपी करें';

  @override
  String get building_your_timeline => 'आपकी सुनने की आदतों के आधार पर आपकी टाइमलाइन बनाई जा रही है...';
  ...
  @override
  String get plugin_requires_authentication => 'प्लगइन को प्रमाणीकरण की आवश्यकता है';
  ...
  @override
  String get plugin_scrobbling_info => 'यह प्लगइन आपके सुनने के इतिहास को उत्पन्न करने के लिए आपके संगीत को स्क्रॉबल करता है।';
  ...
  @override
  String get do_you_want_to_install_this_plugin => 'क्या आप इस प्लगइन को स्थापित करना चाहते हैं?';

  @override
  String get third_party_plugin_warning => 'यह प्लगइन एक तृतीय-पक्ष रिपॉजिटरी से है। कृपया सुनिश्चित करें कि आप इसे स्थापित करने से पहले स्रोत पर भरोसा करते हैं।';
  ...
  @override
  String get synced_lyrics_not_available => 'इस गाने के लिए सिंक्रनाइज़ किए गए बोल उपलब्ध नहीं हैं। कृपया';
  ...
  @override
  String get configure_plugins => 'अपने स्वयं के मेटाडेटा प्रदाता और ऑडियो स्रोत प्लगइन्स कॉन्फ़िगर करें';
  ...
  @override
  String get dab_music_source_description => 'ऑडियोफाइलों के लिए। उच्च-गुणवत्ता/बिना हानि वाले ऑडियो स्ट्रीम प्रदान करता है। सटीक ISRC आधारित ट्रैक मिलान।';
}
