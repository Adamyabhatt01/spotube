...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get encryption_failed_warning => 'SpoTubeはデータを安全に保存するために暗号化を用いますが、暗号化に失敗しました。このため、安全でない保存領域への保存に切り替えます\nOSがLinuxなら、gnome-keyring、kde-wallet、keepassxcなどの管理ツールがインストールされていることを確認してください';
  ...
  @override
  String get help_project_grow_description => 'SpoTubeはオープンソースプロジェクトです。貢献したり、バグ報告したり、新機能を提案することで、プロジェクトの成長に貢献できます。';
  ...
  @override
  String get hipotetical_calculation => '*これは、オンライン音楽ストリーミングプラットフォームの1ストリームあたりの平均支払い額である\$0.003〜\$0.005に基づいて計算されています。これは、ユーザーが異なる音楽ストリーミングプラットフォームで曲を聴いた場合に、アーティストにどれだけ支払ったかを把握するための仮説的な計算です。';
  ...
  @override
  String get webview_not_found_description => '端末にWebviewランタイムがインストールされていません。\nインストールされている場合は、環境変数のパスにあるか確認してください\n\nインストール後、アプリを再起動してください';
  ...
  @override
  String get port_helper_msg => '初期設定は-1で、ランダムな番号を示します。ファイアウォールを設定している場合に設定することを推奨します。';
  ...
  @override
  String get no_default_metadata_provider_selected => 'デフォルトのメタデータプロバイダーが設定されていません';
  ...
  @override
  String get unsafe_url_warning => '信頼できないソースからのリンクを開くのは安全ではない場合があります。注意してください！\nリンクをクリップボードにコピーすることもできます。';
  ...
  @override
  String get third_party_plugin_warning => 'このプラグインはサードパーティのリポジトリからのものです。インストールする前にソースを信頼できるか確認してください。';
  ...
  @override
  String get paste_plugin_download_url => 'ダウンロードURL、GitHub/CodebergリポジトリURL、または.smplugファイルへの直接リンクを貼り付けます';

  @override
  String get download_and_install_plugin_from_url => 'URLからプラグインをダウンロードしてインストール';
  ...
  @override
  String get dab_music_source_description => 'オーディオファイル向け。高品質/ロスレスオーディオストリームを提供。正確なISRCベースのトラックマッチング。';
}
