...
class AppLocalizationsKa extends AppLocalizations {
  ...
  @override
  String get no_default_metadata_provider_selected => 'თქვენ არ გაქვთ დაყენებული ნაგულისხმევი მეტამონაცემების პროვაიდერი';

  @override
  String get manage_metadata_providers => 'მეტამონაცემების პროვაიდერების მართვა';

  @override
  String get open_link_in_browser => 'ბმულის გახსნა ბრაუზერში?';

  @override
  String get do_you_want_to_open_the_following_link => 'გსურთ გახსნათ შემდეგი ბმული';

  @override
  String get unsafe_url_warning => 'შეიძლება სახიფათო იყოს ბმულების გახსნა უნდობელი წყაროებიდან. იყავით ფრთხილად!\nასევე შეგიძლიათ დააკოპიროთ ბმული თქვენს ბუფერში.';

  @override
  String get copy_link => 'ბმულის კოპირება';

  @override
  String get building_your_timeline => 'თქვენი დროის ხაზის აგება თქვენი მოსმენების საფუძველზე...';
  ...
  @override
  String get plugin_requires_authentication => 'პლაგინი საჭიროებს ავთენტიფიკაციას';
  ...
  @override
  String get plugin_scrobbling_info => 'ეს პლაგინი აწარმოებს თქვენი მუსიკის სქრობლინგს, რათა შექმნას თქვენი მოსმენის ისტორია.';

  @override
  String get default_metadata_source => 'ნაგულისხმევი მეტამონაცემების წყარო';

  @override
  String get set_default_metadata_source => 'ნაგულისხმევი მეტამონაცემების წყაროს დაყენება';
  ...
  @override
  String get do_you_want_to_install_this_plugin => 'გსურთ ამ პლაგინის დაყენება?';

  @override
  String get third_party_plugin_warning => 'ეს პლაგინი არის მესამე მხარის საცავიდან. გთხოვთ, დარწმუნდეთ, რომ ენდობით წყაროს დაყენებამდე.';

  @override
  String get author => 'ავტორი';

  @override
  String get this_plugin_can_do_following => 'ამ პლაგინს შეუძლია შემდეგის გაკეთება';

  @override
  String get install => 'დაყენება';

  @override
  String get install_a_metadata_provider => 'დააყენეთ მეტამონაცემების პროვაიდერი';

  @override
  String get no_tracks_playing => 'ამჟამად არ უკრავს არცერთი ტრეკი';

  @override
  String get synced_lyrics_not_available => 'ამ სიმღერისთვის სინქრონიზებული ტექსტები არ არის ხელმისაწვდომი. გთხოვთ, გამოიყენოთ';
  ...
  @override
  String get configure_plugins => 'თქვენი საკუთარი მეტამონაცემებისა და აუდიო წყაროს პლაგინების კონფიგურაცია';
  ...
  @override
  String get dab_music_source_description => 'აუდიოფილებისთვის. უზრუნველყოფს მაღალი ხარისხის/უკომპრესო აუდიო სტრიმებს. ზუსტი შესაბამისობა ISRC-ის მიხედვით.';
}
