...
class AppLocalizationsKo extends AppLocalizations {
  ...
  @override
  String get hipotetical_calculation => '*이것은 온라인 음악 스트리밍 플랫폼의 스트림당 평균 지불액인 \$0.003에서 \$0.005를 기준으로 계산됩니다. 이것은 사용자가 다른 음악 스트리밍 플랫폼에서 노래를 들었다면 아티스트에게 얼마를 지불했을지에 대한 통찰력을 제공하기 위한 가상 계산입니다.';
  ...
  @override
  String get no_default_metadata_provider_selected => '기본 메타데이터 제공자가 설정되지 않았습니다';
  ...
  @override
  String get unsafe_url_warning => '신뢰할 수 없는 출처의 링크를 여는 것은 안전하지 않을 수 있습니다. 주의하세요!\n링크를 클립보드에 복사할 수도 있습니다.';
  ...
  @override
  String get third_party_plugin_warning => '이 플러그인은 타사 리포지토리에서 제공됩니다. 설치하기 전에 출처를 신뢰하는지 확인하세요.';
  ...
  @override
  String get paste_plugin_download_url => '다운로드 URL, GitHub/Codeberg 리포지토리 URL 또는 .smplug 파일에 대한 직접 링크를 붙여넣으세요';
  ...
  @override
  String get dab_music_source_description => '오디오파일을 위한 소스입니다. 고음질/무손실 오디오 스트림을 제공하며 ISRC 기반으로 정확한 트랙 매칭을 지원합니다.';
}
