...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get no_default_metadata_provider_selected => 'Вы не выбрали поставщика метаданных по умолчанию';
  ...
  @override
  String get do_you_want_to_open_the_following_link => 'Вы хотите открыть следующую ссылку';

  @override
  String get unsafe_url_warning => 'Открытие ссылок из ненадежных источников может быть небезопасным. Будьте осторожны!\nВы также можете скопировать ссылку в буфер обмена.';

  @override
  String get copy_link => 'Копировать ссылку';

  @override
  String get building_your_timeline => 'Создание вашей временной шкалы на основе ваших прослушиваний...';
  ...
  @override
  String get plugin_scrobbling_info => 'Этот плагин скробблит вашу музыку для создания вашей истории прослушиваний.';

  @override
  String get default_metadata_source => 'Источник метаданных по умолчанию';

  @override
  String get set_default_metadata_source => 'Задать источник метаданных по умолчанию';
  ...
  @override
  String get do_you_want_to_install_this_plugin => 'Вы хотите установить этот плагин?';

  @override
  String get third_party_plugin_warning => 'Этот плагин из стороннего репозитория. Пожалуйста, убедитесь, что вы доверяете источнику перед установкой.';

  @override
  String get author => 'Автор';

  @override
  String get this_plugin_can_do_following => 'Этот плагин может выполнять следующее';
  ...
  @override
  String get no_tracks_playing => 'В настоящее время не воспроизводится ни один трек';

  @override
  String get synced_lyrics_not_available => 'Синхронизированные тексты недоступны для этой песни. Пожалуйста, используйте вкладку';
  ...
  @override
  String get configure_plugins => 'Настройте собственные плагины провайдеров метаданных и источников аудио';
  ...
  @override
  String get dab_music_source_description => 'Для аудиофилов. Предоставляет высококачественные/lossless аудиопотоки. Точное совпадение треков по ISRC.';
}
