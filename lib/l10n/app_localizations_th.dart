...
class AppLocalizationsTh extends AppLocalizations {
  ...
  @override
  String get hipotetical_calculation => '*การคำนวณนี้อิงจากค่าเฉลี่ยการจ่ายเงินต่อสตรีมของแพลตฟอร์มสตรีมมิ่งเพลงออนไลน์ที่ \$0.003 ถึง \$0.005 นี่เป็นการคำนวณสมมติฐานเพื่อให้ผู้ใช้เข้าใจว่าพวกเขาจะต้องจ่ายเงินให้ศิลปินเท่าไหร่หากพวกเขาฟังเพลงบนแพลตฟอร์มสตรีมมิ่งเพลงที่แตกต่างกัน';
  ...
  @override
  String get no_default_metadata_provider_selected => 'คุณไม่ได้ตั้งค่าผู้ให้บริการเมตาดาต้าเริ่มต้น';
  ...
  @override
  String get do_you_want_to_open_the_following_link => 'คุณต้องการเปิดลิงก์ต่อไปนี้หรือไม่';

  @override
  String get unsafe_url_warning => 'การเปิดลิงก์จากแหล่งที่ไม่น่าเชื่อถืออาจไม่ปลอดภัย โปรดระมัดระวัง!\nคุณยังสามารถคัดลอกลิงก์ไปยังคลิปบอร์ดของคุณได้';

  @override
  String get copy_link => 'คัดลอกลิงก์';

  @override
  String get building_your_timeline => 'กำลังสร้างไทม์ไลน์ของคุณตามการฟังของคุณ...';
  ...
  @override
  String get plugin_requires_authentication => 'ปลั๊กอินต้องมีการรับรองความถูกต้อง';
  ...
  @override
  String get plugin_scrobbling_info => 'ปลั๊กอินนี้จะ scrobble เพลงของคุณเพื่อสร้างประวัติการฟังของคุณ';
  ...
  @override
  String get do_you_want_to_install_this_plugin => 'คุณต้องการติดตั้งปลั๊กอินนี้หรือไม่?';

  @override
  String get third_party_plugin_warning => 'ปลั๊กอินนี้มาจากที่เก็บของบุคคลที่สาม โปรดตรวจสอบให้แน่ใจว่าคุณเชื่อถือแหล่งที่มาก่อนทำการติดตั้ง';
  ...
  @override
  String get synced_lyrics_not_available => 'ไม่มีเนื้อเพลงที่ซิงค์สำหรับเพลงนี้ กรุณาใช้แท็บ';
  ...
  @override
  String get paste_plugin_download_url => 'วาง url ดาวน์โหลดหรือ url ที่เก็บ GitHub/Codeberg หรือลิงก์โดยตรงไปยังไฟล์ .smplug';

  @override
  String get download_and_install_plugin_from_url => 'ดาวน์โหลดและติดตั้งปลั๊กอินจาก url';
  ...
  @override
  String get configure_plugins => 'กำหนดค่าปลั๊กอินผู้ให้บริการเมตาดาต้าและแหล่งเสียงของคุณเอง';
  ...
  @override
  String get dab_music_source_description => 'สำหรับคนรักเสียงเพลง ให้สตรีมเสียงคุณภาพสูง/ไร้การสูญเสียการบีบอัด การจับคู่แทร็กแม่นยำตาม ISRC';
}
