...
class AppLocalizationsTr extends AppLocalizations {
  ...
  @override
  String get no_default_metadata_provider_selected => 'Varsayılan bir meta veri sağlayıcısı ayarlanmadı';
  ...
  @override
  String get do_you_want_to_open_the_following_link => 'Aşağıdaki bağlantıyı açmak istiyor musunuz';

  @override
  String get unsafe_url_warning => 'Güvenilmeyen kaynaklardan bağlantı açmak güvensiz olabilir. Dikkatli olun!\nBağlantıyı panonuza da kopyalayabilirsiniz.';

  @override
  String get copy_link => 'Bağlantıyı Kopyala';

  @override
  String get building_your_timeline => 'Dinlemelerinize göre zaman çizelgeniz oluşturuluyor...';
  ...
  @override
  String get plugin_requires_authentication => 'Eklenti kimlik doğrulama gerektirir';
  ...
  @override
  String get plugin_scrobbling_info => 'Bu eklenti, dinleme geçmişinizi oluşturmak için müziğinizi scrobble eder.';

  @override
  String get default_metadata_source => 'Varsayılan meta veri kaynağı';

  @override
  String get set_default_metadata_source => 'Varsayılan meta veri kaynağını ayarla';
  ...
  @override
  String get do_you_want_to_install_this_plugin => 'Bu eklentiyi yüklemek istiyor musunuz?';

  @override
  String get third_party_plugin_warning => 'Bu eklenti üçüncü taraf bir depodan gelmektedir. Lütfen yüklemeden önce kaynağa güvendiğinizden emin olun.';

  @override
  String get author => 'Yazar';

  @override
  String get this_plugin_can_do_following => 'Bu eklenti aşağıdakileri yapabilir';
  ...
  @override
  String get synced_lyrics_not_available => 'Bu şarkı için senkronize şarkı sözleri mevcut değil. Lütfen';
  ...
  @override
  String get paste_plugin_download_url => 'İndirme url\'sini veya GitHub/Codeberg repo url\'sini veya .smplug dosyasına doğrudan bağlantıyı yapıştırın';

  @override
  String get download_and_install_plugin_from_url => 'url\'den eklentiyi indir ve yükle';
  ...
  @override
  String get configure_plugins => 'Kendi meta veri sağlayıcı ve ses kaynağı eklentilerinizi yapılandırın';
  ...
  @override
  String get dab_music_source_description => 'Audiophile\'ler için. Yüksek kaliteli/kayıpsız ses akışları sağlar. Doğru ISRC tabanlı parça eşleştirme.';
}
