...
class AppLocalizationsVi extends AppLocalizations {
  ...
  @override
  String get no_default_metadata_provider_selected => 'Bạn chưa đặt nhà cung cấp siêu dữ liệu mặc định nào';
  ...
  @override
  String get do_you_want_to_open_the_following_link => 'Bạn có muốn mở liên kết sau không';

  @override
  String get unsafe_url_warning => 'Việc mở các liên kết từ các nguồn không đáng tin cậy có thể không an toàn. Hãy thận trọng!\nBạn cũng có thể sao chép liên kết vào khay nhớ tạm của mình.';

  @override
  String get copy_link => 'Sao chép liên kết';

  @override
  String get building_your_timeline => 'Đang xây dựng dòng thời gian của bạn dựa trên những gì bạn đã nghe...';
  ...
  @override
  String get plugin_scrobbling_info => 'Plugin này scrobble nhạc của bạn để tạo lịch sử nghe của bạn.';
  ...
  @override
  String get do_you_want_to_install_this_plugin => 'Bạn có muốn cài đặt plugin này không?';

  @override
  String get third_party_plugin_warning => 'Plugin này đến từ một kho lưu trữ của bên thứ ba. Vui lòng đảm bảo rằng bạn tin tưởng nguồn trước khi cài đặt.';

  @override
  String get author => 'Tác giả';

  @override
  String get this_plugin_can_do_following => 'Plugin này có thể làm những việc sau';

  @override
  String get install => 'Cài đặt';

  @override
  String get install_a_metadata_provider => 'Cài đặt một Nhà cung cấp siêu dữ liệu';

  @override
  String get no_tracks_playing => 'Hiện không có bản nhạc nào đang phát';

  @override
  String get synced_lyrics_not_available => 'Lời bài hát được đồng bộ hóa không có sẵn cho bài hát này. Vui lòng sử dụng';
  ...
  @override
  String get configure_plugins => 'Cấu hình nhà cung cấp siêu dữ liệu và tiện ích nguồn âm thanh riêng';
  ...
  @override
  String get dab_music_source_description => 'Dành cho người yêu âm nhạc chất lượng cao. Cung cấp luồng âm thanh chất lượng cao/không nén. Phù hợp bài hát dựa trên ISRC chính xác.';
}
