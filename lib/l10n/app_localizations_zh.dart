...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get hipotetical_calculation => '*这是根据在线音乐流媒体平台每流平均支付0.003美元至0.005美元计算得出的。这是一个假设性的计算，旨在让用户了解如果他们在不同的音乐流媒体平台上收听歌曲，他们将需要向艺人支付多少费用。';
  ...
  @override
  String get paste_plugin_download_url => '粘贴下载 URL、GitHub/Codeberg 存储库 URL 或 .smplug 文件的直接链接';
  ...
  @override
  String get dab_music_source_description => '适合发烧友。提供高质量/无损音频流。基于 ISRC 的精确曲目匹配。';
}
...
class AppLocalizationsZhTw extends AppLocalizationsZh {
  ...
  @override
  String get credentials_will_not_be_shared_disclaimer => '您大可放心，軟體不會收集或分享任何個人資料給第三方';
  ...
  @override
  String get download_warning => '如果你大量下載這些歌曲，你顯然在侵犯音樂的版權並對音樂創作社區造成了傷害。我希望你能意識到這一點。永遠要尊重並支持藝術家們的辛勤工作';

  @override
  String get download_ip_ban_warning => '小心，如果出現超出正常的下載請求，那你的 IP 可能會被 YouTube 封鎖，這意味著你的裝置將在長達 2-3 個月的時間內無法使用該 IP 訪問 YouTube（即使你沒登入）。Spotube 不會因而承擔任何責任';
  ...
  @override
  String get download_agreement_3 => '我完全了解我的 IP 存在被 YouTube 封鎖的風險。並且我明白 Spotube 的擁有者與貢獻者們無須對我目前的行為所導致的任何後果負責';
  ...
  @override
  String get encryption_failed_warning => 'Spotube使用加密來安全地儲存您的資料。但是失敗了。因此，它將回退到不安全的儲存空間\n如果您使用Linux，請確保已安裝gnome-keyring、kde-wallet和keepassxc等加密服務';
  ...
  @override
  String get help_project_grow_description => 'Spotube是一個開源專案。您可以透過為專案做出貢獻、回報錯誤或建議新功能來幫助專案成長。';
  ...
  @override
  String get streaming_fees_hypothetical => '*基於 Spotify 每次播放的支付金額\n從 \$0.003 到 \$0.005 計算。這是一個假設性的\n計算，旨在讓用戶了解如果他們在 Spotify 上收聽\n這些歌曲，可能會付給作者的金額。';
  ...
  @override
  String get hipotetical_calculation => '*此為根據線上音樂串流平台平均每次播放 \$0.003 至 \$0.005 的收益所計算的假設值。此為一個假設性計算，旨在讓使用者了解若他們在不同的音樂串流平台上收聽同一首歌曲，他們將會支付給藝人多少費用。';
  ...
  @override
  String get webview_not_found_description => '您的裝置中未安裝 Webview Runtime。\n如果已安裝，請確保它的位置在系統環境變數（PATH）中\n\n安裝後，重新啟動應用程式';
  ...
  @override
  String get youtube_engine_unix_issue_message => '在類 Unix 作業系統（如 macOS/Linux/Unix）中，請在 .zshrc/.bashrc/.bash_profile 等檔案中設定路徑無效。\n您需要在 shell 設定檔中設定路徑';
  ...
  @override
  String get paste_plugin_download_url => '貼上下載網址、GitHub/Codeberg 儲存庫網址或 .smplug 檔案的直接連結';
  ...
  @override
  String get dab_music_source_description => '適合音響發燒友。提供高品質/無損音訊串流。精確的 ISRC 曲目比對。';
}
