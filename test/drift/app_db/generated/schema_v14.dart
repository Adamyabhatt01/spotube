...
class PreferencesTable extends Table
  ...
  late final GeneratedColumn<bool> cacheMusic = GeneratedColumn<bool>(
      ...
      defaultValue: const CustomExpression('1'));
  late final GeneratedColumn<String> sourcePriority = GeneratedColumn<String>(
...
class PreferencesTableData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['source_priority'] = Variable<String>(sourcePriority);
  ...
  factory PreferencesTableData.fromJson(Map<String, dynamic> json,
    ...
    return PreferencesTableData(
      ...
      sourcePriority: serializer.fromJson<String>(json['sourcePriority']),
      autoDownloadQuality:
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'sourcePriority': serializer.toJson<String>(sourcePriority),
...
class PreferencesTableCompanion extends UpdateCompanion<PreferencesTableData> {
  ...
  final Value<String> sourcePriority;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (sourcePriority.present) {
      map['source_priority'] = Variable<String>(sourcePriority.value);
    }
...
class LibrarySnapshotTable extends Table
    with TableInfo<LibrarySnapshotTable, LibrarySnapshotTableData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  LibrarySnapshotTable(this.attachedDatabase, [this._alias]);
  ...
  @override
  LibrarySnapshotTable createAlias(String alias) {
    return LibrarySnapshotTable(attachedDatabase, alias);
  }
}
...
class DatabaseAtV14 extends GeneratedDatabase {
  ...
  late final LibrarySnapshotTable librarySnapshotTable =
      LibrarySnapshotTable(this);
